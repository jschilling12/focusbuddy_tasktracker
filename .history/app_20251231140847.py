...
class timeTracker:
    ...
    def save_time_tracking(self, time_tracking):
        ...
        with open(filename, 'w') as csvfile:
            ...
            tkinter.filedialog.asksaveasfile(mode='w', initialdir=PathFileName, defaultextension=csvfile, title='{today}')
        return True
    ...
    def timed_process(self):
        ...
        while running:
            ...
            if msvcrt.kbhit():
                ...
                process = activeWindow()
                start = time.time()
        return self.save_time_tracking(self.time_tracking)
